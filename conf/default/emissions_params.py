...
# MODEL PARAMETERS
#
# Calibrated variant of params.py for the emissions-policy paper. The 8
# behavioral parameters below (PRODUCTIVITY_EXPONENT, PRODUCTIVITY_MAGNITUDE_
# DIVISOR, MARKUP, STICKY_PRICES, LABOR_MARKET, NATURAL_SEPARATION_RATE,
# PCT_DISTANCE_HIRING, RELEVANCE_UNEMPLOYMENT_SALARIES) are set to the
# top-scoring row from the 2026-08-17 Sobol calibration sweep against real
# Belo Horizonte data (idx=421, score=0.5242) - see
# output/calibration__2026-08-17T10_21_33.228363/calibration_scores.csv.
# Everything else is unchanged from conf/default/params.py.

# FIRMS #########################################################
# Production function, labor with decaying exponent, Alpha for K. [0, 1]
PRODUCTIVITY_EXPONENT = 0.6855183836072684  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
# Order of magnitude correction of production. Production divided by parameter
PRODUCTIVITY_MAGNITUDE_DIVISOR = 0.1918731006793678  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
...
MARKUP = 0.11956881226971745  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
# Frequency firms change prices. Probability < than parameter
STICKY_PRICES = 0.8058782113716007  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
...
LABOR_MARKET = 0.5537648885510862  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)

# Monthly probability an employed worker separates (quits, contract end, etc.).
NATURAL_SEPARATION_RATE = 0.005005828770808875  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
# Percentage of employees' firms hired by distance
PCT_DISTANCE_HIRING = 0.1449629869312048  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
# Ignore unemployment in wage base calculation if parameter is zero, else discount unemployment times parameter
RELEVANCE_UNEMPLOYMENT_SALARIES = 3.6666163317859173  # Sobol-calibrated (BH, 2026-08-17 sweep, idx=421)
