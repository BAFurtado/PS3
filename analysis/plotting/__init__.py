...
class Plotter:
    ...
    def plot_general(self):
        ...
        titles = ['Total population', 'Average goods and services prices\' level', 'GDP absolute value',
                  ...
                  'Number of workers',
                  'Families\' median permanent income',
                  ...
                  'New families endogenously formed',
                  'Amount of $ implemented by policy',
                  'Percentage of Policy Money actually spent',
                  ...
                  'Average QLI index value',
                  'House vacancies',
                  'House prices',
                  'House rent prices',
                  'Mean house qualities',
                  'Number of domicilies',
