...
class Plotter:
    ...
    def plot_general(self):
        ...
        cols = ['pop', 'price_level',
                ...
                'firms_total_profit', 'firms_median_profit', 'share_firms_positive_profit',
        ...
        titles = ['Total population',
                  ...
                  'Unemployment rate',
                  'Median number of workers per firm',
                  'Total employment',
                  'Median family permanent income',
                  'Median family wage income',
                  'Total commuting volume of families',
                  'Total family savings',
                  'Families receiving housing policy support',
                  'New families formed',
                  'Monthly policy subsidy amount',
                  'Share of policy budget spent',
                  'Total firm profits (excl. gov)',
                  'Median firm profit (excl. gov)',
                  'Share of firms with positive profit (excl. gov)',
                  'Median firm inventories',
                  'Average firm eco-efficiency',
                  'Median wage paid by firms',
                  'Median firm innovation investment',
                  'Total firm emissions',
                  'Gini index',
                  'Total family consumption',
                  'Share of families with zero consumption',
                  'Default rate among renter families',
                  ...
                  'Share of renters with zero permanent income',
                  'Sales of external intermediate goods',
                  'FGTS funding usage rate',
                  'SBPE funding usage rate',
                  ...
                  'Denied loans: zero capped amount',
                  'Loan request of zero (savings already sufficed)',
